 ...
 */
#define ST7701_CMD2BK0_SEL			0x10
#define ST7701_CMD2BK1_SEL			0x11
#define ST7701_CMD2BK3_SEL			0x13
#define ST7701_CMD2BKX_SEL_NONE		0x00
...
static void txw210001b0_gip_sequence(struct st7701 *st7701)
{
	...
	ST7701_WRITE(st7701, ST7701_CMD2BKX_SEL,
		   0x77, 0x1, 0x0, 0x0, ST7701_CMD2BK0_SEL);
	...
	ST7701_WRITE(st7701, ST7701_CMD2BKX_SEL,
		   0x77, 0x1, 0x0, 0x0, ST7701_CMD2BK1_SEL);
	...
	ST7701_WRITE(st7701, ST7701_CMD2BKX_SEL,
		   0x77, 0x1, 0x0, 0x0, ST7701_CMD2BK3_SEL);

	ST7701_WRITE(st7701, 0xEF, 0x8);

	ST7701_WRITE(st7701, ST7701_CMD2BKX_SEL,
		   0x77, 0x1, 0x0, 0x0, ST7701_CMD2BKX_SEL_NONE);
...
static int st7701_prepare(struct drm_panel *panel)
{
	...
	if (st7701->dsi) {
		...
		/* SPI */
		ST7701_WRITE(st7701, ST7701_CMD2BKX_SEL,
			   0x77, 0x01, 0x00, 0x00, ST7701_CMD2BKX_SEL_NONE);
	}
